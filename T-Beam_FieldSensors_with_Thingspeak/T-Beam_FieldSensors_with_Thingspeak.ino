...
unsigned long thingspeakUploadInterval = 25000;
...
{ 
  ...
  if (thingspeakUploadMillis >= thingspeakUploadInterval)
  {
    thingspeakUpload();
...
void thingspeakUpload()
{
  ...
  ThingSpeak.setField (3, NValue);
  ThingSpeak.setField (4, NValue);
  ThingSpeak.setField (5, NValue);
